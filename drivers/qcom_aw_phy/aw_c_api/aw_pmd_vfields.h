...
// FFE_TAP_DISABLE
// Description: FFE tap_disable_nt override
#define FFE_TAP_DISABLE_ADDR 0x0200019C
#define FFE_TAP_DISABLE_OFFSET 0x00000000
#define FFE_TAP_DISABLE_BITWIDTH 0x00000017
#define FFE_TAP_DISABLE_MASK 0x007FFFFF

// USE_CUSTOM_FFE_TAP_DISABLE
// Description: Enable custom FFE tap_disable_nt
#define USE_CUSTOM_FFE_TAP_DISABLE_ADDR 0x0200019C
...
#define USE_CUSTOM_ROAMING_WINDOWS_ADDR 0x020001A0
...
// FIRST_FOM_DONE
// Description:
#define FIRST_FOM_DONE_ADDR 0x020001A0
#define FIRST_FOM_DONE_OFFSET 0x0000000A
#define FIRST_FOM_DONE_BITWIDTH 0x00000001
#define FIRST_FOM_DONE_MASK 0x00000400

#define ROAMING_WINDOWS_CFG_ADDR 0x020001A4
...
// FG_ABORTED
// Description: {EVAL_FOM, FULL_FOM, EVAL_DIR, FULL_DIR, INIT}
#define FG_ABORTED_ADDR 0x020001A4
#define FG_ABORTED_OFFSET 0x0000000E
#define FG_ABORTED_BITWIDTH 0x00000005
#define FG_ABORTED_MASK 0x0007C000

// BG_ABORTED
// Description:
#define BG_ABORTED_ADDR 0x020001A4
#define BG_ABORTED_OFFSET 0x00000013
#define BG_ABORTED_BITWIDTH 0x00000001
#define BG_ABORTED_MASK 0x00080000

// NES_DFE_BYPASS_VALUE
// Description:
#define NES_DFE_BYPASS_VALUE_ADDR 0x020001A8
...
// TARGET_CMA_BYPASS_VALUE
// Description:
#define TARGET_CMA_BYPASS_VALUE_ADDR 0x020001A8
...
// CUSTOM_DFE_RATIO
// Description:
#define CUSTOM_DFE_RATIO_ADDR 0x020001B4
...
// USE_REDUCED_TAPS
// Description: USELESS VFIELD ADDED BACK UNTIL C-API IS FIXED
#define USE_REDUCED_TAPS_ADDR 0x020001B8
#define USE_REDUCED_TAPS_OFFSET 0x00000000
#define USE_REDUCED_TAPS_BITWIDTH 0x00000001
#define USE_REDUCED_TAPS_MASK 0x00000001

// REDUCED_TAPS
// Description: USELESS VFIELD ADDED BACK UNTIL C-API IS FIXED
#define REDUCED_TAPS_ADDR 0x020001B8
#define REDUCED_TAPS_OFFSET 0x00000001
#define REDUCED_TAPS_BITWIDTH 0x00000002
#define REDUCED_TAPS_MASK 0x00000006

// USE_AUTO_LOOKUP_DFE_RATIO
// Description:
#define USE_AUTO_LOOKUP_DFE_RATIO_ADDR 0x02000198
#define USE_AUTO_LOOKUP_DFE_RATIO_OFFSET 0x00000000
#define USE_AUTO_LOOKUP_DFE_RATIO_BITWIDTH 0x00000001
#define USE_AUTO_LOOKUP_DFE_RATIO_MASK 0x00000001

// ENABLE_DFE_RATIO
// Description:
#define ENABLE_DFE_RATIO_ADDR 0x02000198
#define ENABLE_DFE_RATIO_OFFSET 0x00000001
#define ENABLE_DFE_RATIO_BITWIDTH 0x00000001
#define ENABLE_DFE_RATIO_MASK 0x00000002
