...
#define AW_ATEST_RX_ATEST_A_AFE_RX_CTLE_VGA_ANA_TOP_OA_AFE_RX_CTLE_VGA_M_HV_ADDR \
  (18)
#define AW_ATEST_RX_ATEST_A_AFE_RX_CTLE_VGA_ANA_TOP_OA_AFE_RX_CTLE_VGA_M_HV_TERM \
  (0)

#define AW_ATEST_RX_ATEST_A_AFE_RX_CTLE_VGA_ANA_TOP_OA_AFE_RX_CTLE_VGA_P_HV_ADDR \
  (19)
#define AW_ATEST_RX_ATEST_A_AFE_RX_CTLE_VGA_ANA_TOP_OA_AFE_RX_CTLE_VGA_P_HV_TERM \
  (0)
