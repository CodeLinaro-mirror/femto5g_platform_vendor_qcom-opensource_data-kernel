...
static void ecpriss_oxtor_hal_reg_construct_rx_n_max_latency_expected(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, rx_n_max_latency_expected_s->max_latency,
...
static void ecpriss_oxtor_hal_reg_construct_rx_n_error_status_dump_reg(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, dump_reg_s->reset_error_dump,
...
static void ecpriss_oxtor_hal_reg_parse_rx_kbyte_cnt_ctl(
	...
	rx_kbyte_cnt_ctl_s->en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_KBYTE_CNT_CTL_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_KBYTE_CNT_CTL_EN_BMSK);

	rx_kbyte_cnt_ctl_s->clr = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_KBYTE_CNT_CTL_CLR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_KBYTE_CNT_CTL_CLR_BMSK);

	return;
}

static void ecpriss_oxtor_hal_reg_parse_qtimer_offset_msb(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_qtimer_offset_msb_s
		*qtimer_offset_msb_s =
		(ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_qtimer_offset_msb_s *)
	...
	qtimer_offset_msb_s->offset_sign_bit = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_QTIMER_OFFSET_MSB_OFFSET_SIGN_BIT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_QTIMER_OFFSET_MSB_OFFSET_SIGN_BIT_BMSK);

	qtimer_offset_msb_s->offset_msbs = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_QTIMER_OFFSET_MSB_OFFSET_MSBS_SHFT,
			HWIO_ECPRI_ORAN_XTOR_QTIMER_OFFSET_MSB_OFFSET_MSBS_BMSK);

	return;
}

static void ecpriss_oxtor_hal_reg_parse_rx_n_max_latency_expected(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_max_latency_expected_s
		*rx_n_max_latency_expected_s =
		(ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_max_latency_expected_s
	...
	rx_n_max_latency_expected_s
		->max_latency = ECPRISS_HAL_GETFIELD_FROM_REG(
				val,
				HWIO_ECPRI_ORAN_XTOR_RX_n_MAX_LATENCY_EXPECTED_MAX_LATENCY_SHFT,
				HWIO_ECPRI_ORAN_XTOR_RX_n_MAX_LATENCY_EXPECTED_MAX_LATENCY_BMSK);
...
static void
ecpriss_oxtor_hal_reg_parse_rx_n_ctl_reg(enum ecpriss_oxtor_hal_reg_name reg,
		void *fields, u32 val) {
	ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_ctl_reg_s
		*rx_n_ctl_reg_s =
		(ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_ctl_reg_s *)
	...
	rx_n_ctl_reg_s->max_bw_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MAX_BW_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MAX_BW_EN_BMSK);

	rx_n_ctl_reg_s->min_bw_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MIN_BW_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MIN_BW_EN_BMSK);

	rx_n_ctl_reg_s->max_bw_clear = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MAX_BW_CLEAR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MAX_BW_CLEAR_BMSK);

	rx_n_ctl_reg_s->min_bw_clear = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MIN_BW_CLEAR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MIN_BW_CLEAR_BMSK);

	rx_n_ctl_reg_s->max_latency_clear = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MAX_LATENCY_CLEAR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MAX_LATENCY_CLEAR_BMSK);

	rx_n_ctl_reg_s->min_latency_clear = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MIN_LATENCY_CLEAR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_MIN_LATENCY_CLEAR_BMSK);

	rx_n_ctl_reg_s->avg_latency_clear = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_AVG_LATENCY_CLEAR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_AVG_LATENCY_CLEAR_BMSK);

	rx_n_ctl_reg_s->seqnum_err_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_SEQNUM_ERR_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_SEQNUM_ERR_EN_BMSK);

	rx_n_ctl_reg_s->latency_err_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_LATENCY_ERR_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_LATENCY_ERR_EN_BMSK);

	rx_n_ctl_reg_s->crc_err_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_CRC_ERR_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_CRC_ERR_EN_BMSK);

	rx_n_ctl_reg_s->len_err_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_LEN_ERR_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_LEN_ERR_EN_BMSK);

	rx_n_ctl_reg_s->time_err_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_TIME_ERR_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_TIME_ERR_EN_BMSK);

	rx_n_ctl_reg_s->data_err_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_DATA_ERR_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_DATA_ERR_EN_BMSK);

	rx_n_ctl_reg_s->tgt_rx_err_en = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_TGT_RX_ERR_EN_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_CTL_REG_TGT_RX_ERR_EN_BMSK);

	return;
}

static void ecpriss_oxtor_hal_reg_parse_rx_n_error_status_dump_reg(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_error_status_dump_reg_s
		*rx_n_error_status_dump_reg_s =
		(ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_error_status_dump_reg_s
		 *)fields;

	rx_n_error_status_dump_reg_s->seqnum_err =
		ECPRISS_HAL_GETFIELD_FROM_REG(
				val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_SEQNUM_ERR_SHFT,
				HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_SEQNUM_ERR_BMSK);

	rx_n_error_status_dump_reg_s->latency_err =
		ECPRISS_HAL_GETFIELD_FROM_REG(
				val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LATENCY_ERR_SHFT,
				HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LATENCY_ERR_BMSK);

	rx_n_error_status_dump_reg_s->crc_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_CRC_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_CRC_ERR_BMSK);

	rx_n_error_status_dump_reg_s->len_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LEN_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LEN_ERR_BMSK);

	rx_n_error_status_dump_reg_s->time_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TIME_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TIME_ERR_BMSK);

	rx_n_error_status_dump_reg_s->data_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_DATA_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_DATA_ERR_BMSK);

	rx_n_error_status_dump_reg_s->tgt_rx_err =
		ECPRISS_HAL_GETFIELD_FROM_REG(
				val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TGT_RX_ERR_SHFT,
				HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TGT_RX_ERR_BMSK);

	rx_n_error_status_dump_reg_s->reset_error_dump =
		ECPRISS_HAL_GETFIELD_FROM_REG(
				val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_RESET_ERR_STATUS_SHFT,
	...
	static void
ecpriss_oxtor_hal_reg_parse_tx_n_ctl_reg(enum ecpriss_oxtor_hal_reg_name reg,
		void *fields, u32 val)
...
static void
ecpriss_oxtor_hal_reg_parse_tx_n_cmd_m_k(enum ecpriss_oxtor_hal_reg_name reg,
		void *fields, u32 val) {
	// TODO
...
static void ecpriss_oxtor_hal_reg_construct_tx_n_cmd_m_k(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, tx_cmd->data, HWIO_ECPRI_ORAN_XTOR_TX_n_CMD_m_k_DATA_SHFT,
...
static void ecpriss_oxtor_hal_reg_parse_tx_n_data_idxs_reg(
	...
	data_idxs_reg_s->rd_idx = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_TX_n_DATA_IDXS_REG_RD_IDX_SHFT,
			HWIO_ECPRI_ORAN_XTOR_TX_n_DATA_IDXS_REG_RD_IDX_BMSK);

	data_idxs_reg_s->wr_idx = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_TX_n_DATA_IDXS_REG_WR_IDX_SHFT,
			HWIO_ECPRI_ORAN_XTOR_TX_n_DATA_IDXS_REG_WR_IDX_BMSK);
...
static void
ecpriss_oxtor_hal_reg_parse_rx_n_error_reg(enum ecpriss_oxtor_hal_reg_name reg,
		void *fields, u32 val) {
	...
	data_idxs_reg_s->seqnum_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_SEQNUM_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_SEQNUM_ERR_BMSK);

	data_idxs_reg_s->latency_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LATENCY_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LATENCY_ERR_BMSK);

	data_idxs_reg_s->crc_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_CRC_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_CRC_ERR_BMSK);

	data_idxs_reg_s->len_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LEN_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_LEN_ERR_BMSK);

	data_idxs_reg_s->time_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TIME_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TIME_ERR_BMSK);

	data_idxs_reg_s->data_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_DATA_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_DATA_ERR_BMSK);

	data_idxs_reg_s->tgt_rx_err = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TGT_RX_ERR_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_TGT_RX_ERR_BMSK);

	data_idxs_reg_s->reset_err_status = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_RESET_ERR_STATUS_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_REG_RESET_ERR_STATUS_BMSK);
...
static void ecpriss_oxtor_hal_reg_parse_rx_kbyte_cnt_qtimer_delta_1(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	qtimer_delta_1->qtimer_msb = ECPRISS_HAL_GETFIELD_FROM_REG(
			val,
...
static void ecpriss_oxtor_hal_reg_parse_rx_kbyte_cnt_qtimer_delta_0(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_kbyte_cnt_qtimer_delta_0_s
		*qtimer_delta_0 =
		(ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_kbyte_cnt_qtimer_delta_0_s
	...
	qtimer_delta_0->qtimer_lsb = ECPRISS_HAL_GETFIELD_FROM_REG(
			val,
			HWIO_ECPRI_ORAN_XTOR_RX_KBYTE_CNT_QTIMER_DELTA_0_QTIMER_LSB_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_KBYTE_CNT_QTIMER_DELTA_0_QTIMER_LSB_BMSK);
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_kbyte_cnt_reg(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	kbyte_cnt_reg->kbyte_cnt = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_KBYTE_CNT_REG_KBYTE_CNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_KBYTE_CNT_REG_KBYTE_CNT_BMSK);
...
static void ecpriss_oxtor_hal_reg_construct_rx_n_err_counters_1(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, err_counters_1->overall_err_count,
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_err_counters_1(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_err_counters_1_s
		*err_counters_1 =
		(ecpri_oran_xtor_hwio_def_ecpri_oran_xtor_rx_n_err_counters_1_s
	...
	err_counters_1->crc_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_CRC_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_CRC_ERR_COUNT_BMSK);

	err_counters_1->data_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_DATA_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_DATA_ERR_COUNT_BMSK);

	err_counters_1->latency_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_LATENCY_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_LATENCY_ERR_COUNT_BMSK);

	err_counters_1->overall_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_OVERALL_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_1_OVERALL_ERR_COUNT_BMSK);
...
static void ecpriss_oxtor_hal_reg_construct_rx_n_err_counters_0(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, err_counters_0->seqnum_err_count,
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_err_counters_0(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	err_counters_0->seqnum_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_SEQNUM_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_SEQNUM_ERR_COUNT_BMSK);

	err_counters_0->len_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_LEN_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_LEN_ERR_COUNT_BMSK);

	err_counters_0->time_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_TIME_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_TIME_ERR_COUNT_BMSK);

	err_counters_0->tgt_rx_err_count = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_TGT_RX_ERR_COUNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERR_COUNTERS_0_TGT_RX_ERR_COUNT_BMSK);
...
static void ecpriss_oxtor_hal_reg_construct_rx_n_error_dump_0_reg(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, error_dump_0_reg->ecpri_msg_type,
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_error_dump_0_reg(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	error_dump_0_reg->ecpri_msg_type = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_ECPRI_MSG_TYPE_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_ECPRI_MSG_TYPE_BMSK);

	error_dump_0_reg->src_tx = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_SRC_TX_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_SRC_TX_BMSK);

	error_dump_0_reg->tgt_rx = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_TGT_RX_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_TGT_RX_BMSK);

	error_dump_0_reg->seqnum = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_SEQNUM_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_SEQNUM_BMSK);

	error_dump_0_reg->xu_num = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_XU_NUM_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_0_REG_XU_NUM_BMSK);
...
static void ecpriss_oxtor_hal_reg_construct_rx_n_error_dump_1_reg(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, error_dump_1_reg->ecpri_payload_size,
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, error_dump_1_reg->ecpri_pcid,
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_error_dump_1_reg(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	error_dump_1_reg->ecpri_payload_size = ECPRISS_HAL_GETFIELD_FROM_REG(
			val,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_1_REG_ECPRI_PAYLOAD_SIZE_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_1_REG_ECPRI_PAYLOAD_SIZE_BMSK);

	error_dump_1_reg->ecpri_pcid = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_1_REG_ECPRI_PCID_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_1_REG_ECPRI_PCID_BMSK);
...
static void ecpriss_oxtor_hal_reg_construct_rx_n_error_dump_2_reg(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, error_dump_2_reg->timestamp,
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_error_dump_2_reg(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	error_dump_2_reg->timestamp = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_2_REG_TIMESTAMP_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_2_REG_TIMESTAMP_BMSK);
...
static void ecpriss_oxtor_hal_reg_construct_rx_n_error_dump_3_reg(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, error_dump_3_reg->init_data,
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_error_dump_3_reg(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	error_dump_3_reg->init_data = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_3_REG_INIT_DATA_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_ERROR_DUMP_3_REG_INIT_DATA_BMSK);
...
static void ecpriss_oxtor_hal_reg_construct_tx_n_backpressure_cnt_reg(
	...
	ECPRISS_HAL_SETFIELD_IN_REG(
			*val, backpressure_cnt_reg->backpressure_cnt,
...
static void ecpriss_oxtor_hal_reg_parse_tx_n_backpressure_cnt_reg(
		enum ecpriss_oxtor_hal_reg_name reg, void *fields, u32 val) {
	...
	backpressure_cnt_reg->backpressure_cnt = ECPRISS_HAL_GETFIELD_FROM_REG(
			val,
			HWIO_ECPRI_ORAN_XTOR_TX_n_BACKPRESSURE_CNT_REG_BACKPRESSURE_CNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_TX_n_BACKPRESSURE_CNT_REG_BACKPRESSURE_CNT_BMSK);
...
static void ecpriss_oxtor_hal_reg_parse_tx_n_pkt_cnt_reg(
	...
	tx_n_pkt_cnt_reg->pkt_cnt = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_TX_n_PKT_CNT_REG_PKT_CNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_TX_n_PKT_CNT_REG_PKT_CNT_BMSK);
...
static void ecpriss_oxtor_hal_reg_parse_rx_n_pkt_cnt_reg(
	...
	rx_n_pkt_cnt_reg->pkt_cnt = ECPRISS_HAL_GETFIELD_FROM_REG(
			val, HWIO_ECPRI_ORAN_XTOR_RX_n_PKT_CNT_REG_PKT_CNT_SHFT,
			HWIO_ECPRI_ORAN_XTOR_RX_n_PKT_CNT_REG_PKT_CNT_BMSK);
...
ecpriss_oxtor_hal_reg_objs[ECPRISS_OXTOR_HW_MAX][ECPRI_OXTOR_OXTOR_MAX] = {
	...
	{ecpriss_oxtor_hal_reg_construct_rx_kbyte_cnt_qtimer_delta_1,
		ecpriss_oxtor_hal_reg_parse_rx_kbyte_cnt_qtimer_delta_1,
	...
	{ecpriss_oxtor_hal_reg_construct_rx_kbyte_cnt_qtimer_delta_0,
		ecpriss_oxtor_hal_reg_parse_rx_kbyte_cnt_qtimer_delta_0,
...
void ecpri_oxtor_hal_reg_write(ecpri_oxtor_hal_reg_type_e reg_type, u32 offset,
		u32 val) {
	if (reg_type == ECPRI_OXTOR_REG_TYPE_GLOBAL) {
...
void ecpriss_oxtor_hal_write_reg_mn_fields(enum ecpriss_oxtor_hal_reg_name reg,
	...
	offset += ecpriss_oxtor_hal_reg_objs[ecpriss_oxtor_hal_ctx.hw_type][reg]
		.n_ofst *
		n;
	ecpriss_oxtor_hal_reg_objs[ecpriss_oxtor_hal_ctx.hw_type][reg]
		.construct(reg, fields, &val);
	base += offset;
	iowrite32(val, &base);
}
