...
#define ECPRI_DMA_REG_SAVE_GSI_EV_CH_MAX (HWIO_GSI_EE_n_EV_CH_k_CNTXT_0_MAXk + 1)
#define ECPRI_DMA_REG_SAVE_GSI_CH_MAX (HWIO_GSI_EE_n_GSI_CH_k_CNTXT_0_MAXk + 1)

#define ECPRI_DMA_MAX_EE (7)
...
#define ECPRI_DMA_REG_SAVE_FW_VER_ROW                     (64)
