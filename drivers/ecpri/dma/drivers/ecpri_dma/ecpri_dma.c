...
static const char * ecpri_dma_status_code_str[] =  {
	[ECPRI_DMA_STATUS_CODE_NORMAL] =
	__stringify(ECPRI_DMA_STATUS_CODE_NORMAL),

	[ECPRI_DMA_STATUS_CODE_PTP] =
	__stringify(ECPRI_DMA_STATUS_CODE_PTP),

	[ECPRI_DMA_STATUS_CODE_FLUSHED] =
	__stringify(ECPRI_DMA_STATUS_CODE_FLUSHED),

	[ECPRI_DMA_STATUS_CODE_P7_EXCEPTION] =
	__stringify(ECPRI_DMA_STATUS_CODE_P7_EXCEPTION),

	[ECPRI_DMA_STATUS_CODE_TIMEOUT_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_TIMEOUT_ERROR),

	[ECPRI_DMA_STATUS_CODE_PKT_LENGTH_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_PKT_LENGTH_ERROR),

	[ECPRI_DMA_STATUS_CODE_SDU_LENGTH_MISMATCH_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_SDU_LENGTH_MISMATCH_ERROR),

	[ECPRI_DMA_STATUS_CODE_TIMESTAMP_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_TIMESTAMP_ERROR),

	[ECPRI_DMA_STATUS_CODE_MSG_LENGTH_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_MSG_LENGTH_ERROR),

	[ECPRI_DMA_STATUS_CODE_MAC_FCS_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_MAC_FCS_ERROR),

	[ECPRI_DMA_STATUS_CODE_SECURITY_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_SECURITY_ERROR),

	[ECPRI_DMA_STATUS_CODE_IPV4_CHECKSUM_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_IPV4_CHECKSUM_ERROR),

	[ECPRI_DMA_STATUS_CODE_UDP_CHECKSUM_ERROR] =
	__stringify(ECPRI_DMA_STATUS_CODE_UDP_CHECKSUM_ERROR),

	[ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT] =
	__stringify(ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT),

	[ECPRI_DMA_STATUS_CODE_MAC_DST_MULTICAST] =
	__stringify(ECPRI_DMA_STATUS_CODE_MAC_DST_MULTICAST),

	[ECPRI_DMA_STATUS_CODE_NON_LCL_MAC_DST] =
	__stringify(ECPRI_DMA_STATUS_CODE_NON_LCL_MAC_DST),

	[ECPRI_DMA_STATUS_CODE_VLAN_FLTR_MISS] =
	__stringify(ECPRI_DMA_STATUS_CODE_VLAN_FLTR_MISS),

	[ECPRI_DMA_STATUS_CODE_IP_FLTR_MISS] =
	__stringify(ECPRI_DMA_STATUS_CODE_IP_FLTR_MISS),

	[ECPRI_DMA_STATUS_CODE_IPV4_FRAG] =
	__stringify(ECPRI_DMA_STATUS_CODE_IPV4_FRAG),

	[ECPRI_DMA_STATUS_CODE_IPV4_OPTIONS] =
	__stringify(ECPRI_DMA_STATUS_CODE_IPV4_OPTIONS),

	[ECPRI_DMA_STATUS_CODE_UNSUP_ETHER_TYPE] =
	__stringify(ECPRI_DMA_STATUS_CODE_UNSUP_ETHER_TYPE),

	[ECPRI_DMA_STATUS_CODE_UNSUP_IP_PROT] =
	__stringify(ECPRI_DMA_STATUS_CODE_UNSUP_IP_PROT),

	[ECPRI_DMA_STATUS_CODE_UDP_FLRT_MISS] =
	__stringify(ECPRI_DMA_STATUS_CODE_UDP_FLRT_MISS),

	[ECPRI_DMA_STATUS_CODE_UDP_MAC_ADDR_HIT] =
	__stringify(ECPRI_DMA_STATUS_CODE_UDP_MAC_ADDR_HIT),

	[ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_0] =
	__stringify(ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_0),

	[ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_1] =
	__stringify(ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_1),

	[ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_2] =
	__stringify(ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_2),

	[ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_3] =
	__stringify(ECPRI_DMA_STATUS_CODE_QUDP_TRAPPED_PKT_PKT_3)
};

const char *ecpri_dma_status_code_to_str(enum ecpri_dma_status_code status_code)
{
	return ecpri_dma_status_code_str[status_code];
}
