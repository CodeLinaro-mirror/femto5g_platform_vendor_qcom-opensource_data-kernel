...
#define HWIO_ECPRI_DMA_DPL_CFG_n_ADDR(n) (DMA_REG_BASE + 0x00008200 + 0x4 * (n))
#define HWIO_ECPRI_DMA_DPL_CFG_n_PHYS(n) (DMA_REG_BASE_PHYS + 0x00008200 + 0x4 * (n))
#define HWIO_ECPRI_DMA_DPL_CFG_n_OFFS(n) (DMA_REG_BASE_OFFS + 0x00008200 + 0x4 * (n))
#define HWIO_ECPRI_DMA_DPL_CFG_n_RMSK 0x3ff
#define HWIO_ECPRI_DMA_DPL_CFG_n_MAXn 73
#define HWIO_ECPRI_DMA_DPL_CFG_n_ATTR 0x3
#define HWIO_ECPRI_DMA_DPL_CFG_n_INI(n) \
in_dword_masked(HWIO_ECPRI_DMA_DPL_CFG_n_ADDR(n), HWIO_ECPRI_DMA_DPL_CFG_n_RMSK)
#define HWIO_ECPRI_DMA_DPL_CFG_n_INMI(n,mask) \
in_dword_masked(HWIO_ECPRI_DMA_DPL_CFG_n_ADDR(n), mask)
#define HWIO_ECPRI_DMA_DPL_CFG_n_OUTI(n,val) \
out_dword(HWIO_ECPRI_DMA_DPL_CFG_n_ADDR(n),val)
#define HWIO_ECPRI_DMA_DPL_CFG_n_OUTMI(n,mask,val) \
out_dword_masked_ns(HWIO_ECPRI_DMA_DPL_CFG_n_ADDR(n),mask,val,HWIO_ECPRI_DMA_DPL_CFG_n_INI(n))
#define HWIO_ECPRI_DMA_DPL_CFG_n_RECORD_ENABLE_BMSK 0x200
#define HWIO_ECPRI_DMA_DPL_CFG_n_RECORD_ENABLE_SHFT 0x9
#define HWIO_ECPRI_DMA_DPL_CFG_n_RECORD_SIZE_BMSK 0x1ff
#define HWIO_ECPRI_DMA_DPL_CFG_n_RECORD_SIZE_SHFT 0x0
