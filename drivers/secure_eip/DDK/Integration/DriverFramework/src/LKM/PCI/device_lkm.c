        ...
        void * CustomInitData_p)
{
    ...
    HWPALLib_Device_Global.Platform.MappedBaseAddr_p = LKM_MappedBaseAddr_Get();
    HWPALLib_Device_Global.Platform.PCI_Device_p     = LKM_DeviceSpecific_Get();
    HWPALLib_Device_Global.Platform.PhysBaseAddr     = LKM_PhysBaseAddr_Get();
    ...
    UMDevXS_PCIDev_Get(
           0,
           &HWPALLib_Device_Global.Platform.PCI_Device_p,
           (void __iomem **)&HWPALLib_Device_Global.Platform.MappedBaseAddr_p);

    if (HWPALLib_Device_Global.Platform.PCI_Device_p == NULL ||
    ...
    if (CustomInitData_p)
    {
        ...
        *p = HWPALLib_Device_Global.Platform.PCI_Device_p->irq;
    }
    ...
    /* Get physical address of the device resource */
    {
        ...
        HWPALLib_Device_Global.Platform.PhysBaseAddr = (void*)PhysAddr;
    }
#endif
        ...
        Device_Data_t * const Data_p)
{
    ...
    DevReference = &HWPALLib_Device_Global.Platform.PCI_Device_p->dev;

    if (Data_p)
        Data_p->PhysAddr = (void*)HWPALLib_Device_Global.Platform.PhysBaseAddr;
        ...
        uint32_t * const Value_p)
{
    ...
    {
        pci_read_config_dword(HWPALLib_Device_Global.Platform.PCI_Device_p,
                              ByteOffset,
                              &Value);
    }
    else
        ...
        const uint32_t ValueIn)
{
    ...
    if (Device_p->FirstOfs == HWPAL_MAGIC_PCICONFIGSPACE)
    {
        pci_write_config_dword(HWPALLib_Device_Global.Platform.PCI_Device_p,
                               ByteOffset,
                               Value);
    }
    else
