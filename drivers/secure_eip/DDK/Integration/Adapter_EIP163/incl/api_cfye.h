...
{
    /** VxLAN UDP port 1 */
    uint16_t VxLAN_Port1;
    /** VxLAN UDP port 2 */
    uint16_t VxLAN_Port2;
} CfyE_L4_Ports_t;

/** Various flags to set in CfyE_Channel_L3L4_t*/

/** Parse IP datagrams */
#define CFYE_VXL_FLAG_PARSE_IP        BIT_0
/** Parse UDP datagrams */
#define CFYE_VXL_FLAG_PARSE_UDP       BIT_1
/** Parse VXLAN Port 1 */
#define CFYE_VXL_FLAG_PARSE_VXLAN1     BIT_20
/** Parse VXLAN Port 2 */
#define CFYE_VXL_FLAG_PARSE_VXLAN2     BIT_21

/** Per-channel L3/L4 header parser configuration */
typedef struct
{
    /** Logical or of CFYE_*_FLAG_* values, specify per-channel header
        parsing*/
    uint32_t flags;
} CfyE_Channel_L3L4_t;
...
typedef struct
{
    ...
    /** L4 port settings, set to NULL of no update is required.*/
    CfyE_L4_Ports_t *L4_Ports_p;
...
typedef enum
{
    ...
    CFYE_RULE_PKT_TYPE_IPSEC_MPLS  = 5,  /**< Packet Type IPsec wtih MPLS  */
    CFYE_RULE_PKT_TYPE_IPSEC_UDP  = 6,  /**< Packet Type IPsec wiht UDP  */
    CFYE_RULE_PKT_TYPE_IPSEC  = 7,  /**< Packet Type IPsec */
