 ...
 */
#include "c_adapter_eip164.h"         /* Configuration */

#include "basic_defs.h"               /* bool */

#include "clib.h"                     /*  C Run-time Library API */

#include "device_mgmt.h"              /* Device Management API. */

#include "adapter_warmboot_support.h" /* WamrBoot support API. */

#include "adapter_init_support.h"     /* Adapter init support API. */
...
Adapter_InitLib_WarmBoot_Areas_Init(void)
{
    ...
    memset(WarmBoot_Devices, 0, Count * sizeof(WarmBoot_DevDescr_t));
