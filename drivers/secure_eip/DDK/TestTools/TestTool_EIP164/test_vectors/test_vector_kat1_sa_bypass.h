...
#ifndef TEST_VECTOR_KAT_1_SA_BYPASS_H_
#define TEST_VECTOR_KAT_1_SA_BYPASS_H_
...
/* MAC SA Bypass Test Case */
#define TEST_MACSEC_REC_PKT_SA_BYPASS_EGRESS                            \
{                                                                       \
    ...
    "TC0104 SA Bypass Egress Test Case",                                \
                                                                        \
    /* CfyE data */                                                     \
    NULL,                                                               \
                                                                        \
    ...
    &vPortStat_SA_Bypass_Egress,                                        \
                                                                        \
    /* Special operation */                                             \
    TEST_MACSEC_OP_NONE,                                                \
}

/* SA Bypass Ingress Test Case */
#define TEST_MACSEC_REC_PKT_SA_BYPASS_INGRESS                           \
{                                                                       \
    /* Test case configuration data */                                  \
    ...
    /* Test case configuration data and test vectors record */          \
                                                                        \
    /* Zero-terminated test case name */                                \
    "TC0105 SA Bypass Ingress Test Case",                               \
                                                                        \
    /* CfyE data */                                                     \
    NULL,                                                               \
                                                                        \
...
#endif /* TEST_VECTOR_KAT_1_SA_BYPASS_H_ */


/* end of file test_vector_kat1_sa_bypass.h */
