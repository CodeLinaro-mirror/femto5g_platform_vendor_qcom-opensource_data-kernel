/* test_vector_kat1_tag_bypass.h
 *
 * Test Tool for CfyE and SecY API's
 * Test vector for tag bypass test case.
 */
...
#ifndef TEST_VECTOR_KAT_1_TAG_BYPASS_H_
#define TEST_VECTOR_KAT_1_TAG_BYPASS_H_
...
#define TEST_MACSEC_REC_PKT_TAG_BYPASS_EGRESS                           \
{                                                                       \
    ...
    "TC19 Tag Bypass Egress Test Case",                                 \
                                                                        \
    /* CfyE data */                                                     \
    NULL,                                                               \
                                                                        \
    ...
    1,                                                                  \
                                                                        \
    /* Transform data */                                                \
    &Transform_Basic_Transform_Egress_TagBypass,                        \
                                                                        \
    /* Number of packets to process */                                  \
    1,                                                                  \
                                                                        \
    /* Packet data */                                                   \
    &Packet_Basic_Transform_Egress_TagBypass,                           \
                                                                        \
...
#define TEST_MACSEC_REC_PKT_TAG_BYPASS_INGRESS                          \
{                                                                       \
    /* Test case configuration data */                                  \
    ...
    /* Test case configuration data and test vectors record */          \
                                                                        \
    /* Zero-terminated test case name */                                \
    "TC20 Tag Bypass Ingress Test Case",                                \
                                                                        \
    /* CfyE data */                                                     \
    NULL,                                                               \
                                                                        \
    ...
    1,                                                                  \
                                                                        \
    /* Packet data*/                                                    \
    &Packet_Basic_Transform_Ingress_TagBypass,                          \
                                                                        \
    /* Number of Channel rules to install */                            \
    4,                                                                  \
                                                                        \
...
#endif /* TEST_VECTOR_KAT_1_TAG_BYPASS_H_ */


/* end of file test_vector_kat1_tag_bypass.h */
