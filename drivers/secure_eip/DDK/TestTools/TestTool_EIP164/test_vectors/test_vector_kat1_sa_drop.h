/* test_vector_kat1_sa_drop.h
 *
 * Test Tool for CfyE and SecY API's
 * Test vector for the drop test case
 */
...
#ifndef TEST_VECTOR_KAT_1_SA_DROP_H_
#define TEST_VECTOR_KAT_1_SA_DROP_H_
...
/* MAC SA Drop Test Case */
#define TEST_MACSEC_REC_PKT_SA_DROP_EGRESS                              \
{                                                                       \
    ...
    "TC0106 SA Drop Egress Test Case",                                  \
                                                                        \
    /* CfyE data */                                                     \
    NULL,                                                               \
                                                                        \
    ...
    1,                                                                  \
                                                                        \
    /* Transform data */                                                \
    &Transform_SA_Drop_Egress,                                          \
                                                                        \
    /* Number of packets to process */                                  \
    1,                                                                  \
                                                                        \
    /* Packet data */                                                   \
    &Packet_SA_Drop_Egress,                                             \
                                                                        \
    ...
    &vPortStat_SA_Drop_Egress,                                          \
                                                                        \
    /* Special operation */                                             \
    TEST_MACSEC_OP_NONE,                                                \
}

/* SA Drop Ingress Test Case */
#define TEST_MACSEC_REC_PKT_SA_DROP_INGRESS                             \
{                                                                       \
    /* Test case configuration data */                                  \
    ...
    /* Test case configuration data and test vectors record */          \
                                                                        \
    /* Zero-terminated test case name */                                \
    "TC0107 SA Drop Ingress Test Case",                                 \
                                                                        \
    /* CfyE data */                                                     \
    NULL,                                                               \
                                                                        \
    ...
    1,                                                                  \
                                                                        \
    /* Transform data */                                                \
    &Transform_SA_Drop_Ingress,                                         \
                                                                        \
    /* Number of packets to process */                                  \
    1,                                                                  \
                                                                        \
    /* Packet data*/                                                    \
    &Packet_SA_Drop_Ingress,                                            \
                                                                        \
    /* Number of Channel rules to install */                            \
    4,                                                                  \
                                                                        \
...
#endif /* TEST_VECTOR_KAT_1_SA_DROP_H_ */


/* end of file test_vector_kat1_sa_drop.h */
