 ...
 * Test record definition for KAT3 test
 */
...
#include "test_vector_kat3.h"      /* TCV_KAT_3 */
        ...
        unsigned int * const TestRecordCount_p)
{
    ...
    *TestRecordCount_p = (sizeof(TCV_KAT_3) / sizeof(Test_Case_Record_t));
    *TestRec_pp        = TCV_KAT_3;
...
/* end of file test_record_kat3.c */
