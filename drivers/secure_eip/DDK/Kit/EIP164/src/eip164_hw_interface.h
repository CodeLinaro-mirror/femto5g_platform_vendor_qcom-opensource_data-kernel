...
#define EIP164_REPLAY_MASK_INTERVAL         128
#define EIP164_REG_REPLAY_MASK(n)           (EIP164_CONF_BASE + 0x60 + \
                                             (0x10000 * ((n) >> 7)) + \
                                             (EIP164_REPLAY_MASK_INTERVAL * \
                                              ((n)& 0x7f)))
/*------------- */
...
#define EIP164_REG_PARSER_IPSEC_DEBUG       (EIP164_CONF_BASE + 0x545C)
...
#define EIP164_SECY_STAT_I_IN_PKTS_LATE_HDR         1
#define EIP164_SECY_STAT_I_IN_PKTS_IP_MISMATCH      2
...
#define EIP164_SA_IPSEC_STAT_I_IN_PKTS_PAD_NOT_VALID      2
#define EIP164_SA_IPSEC_STAT_I_IN_PKTS_REPLAYED           3
#define EIP164_SA_IPSEC_STAT_I_IN_PKTS_PAD_LEN_FAIL       6
#define EIP164_SA_IPSEC_STAT_I_IN_PKTS_PAD_DUMMY          9
...
#define EIP164_REG_PP_INGRESS_HDR_ETYPE     (EIP164_CONF_BASE + 0xF104)
#define EIP164_REG_PP_DEBUG_IP1             (EIP164_CONF_BASE + 0xF160)
#define EIP164_REG_PP_DEBUG_IP2             (EIP164_CONF_BASE + 0xF164)
#define EIP164_REG_PP_DEBUG_IP3             (EIP164_CONF_BASE + 0xF168)
#define EIP164_REG_PP_UDP                   (EIP164_CONF_BASE + 0xF170)
#define EIP164_REG_IPSEC_SECFAIL            (EIP164_CONF_BASE + 0xF174)
