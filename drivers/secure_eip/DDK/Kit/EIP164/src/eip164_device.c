...
#if defined(EIP164_IPSEC_ENABLE)
    rc = EIP164_INGRESS_HDR_ETYPE_WR(Device, Settings_p->IngressHdrEtype);
    if (rc) return rc;
#endif
        ...
        )
{
    ...
    EIP164_CHECK_INT_ATMOST(ChannelId, (TrueIOArea_p->MaxChCount - 1));
#if defined(EIP164_IPSEC_ENABLE)
    EIP164_CHECK_POINTER(fPktNumThrMode_p);
    EIP164_CHECK_POINTER(EtherType_p);
    EIP164_CHECK_POINTER(fPad_NH_Check_p);
    EIP164_CHECK_POINTER(fPadLenCheck_p);
    EIP164_CHECK_POINTER(fPadPatternCheck_p);
    EIP164_CHECK_POINTER(fPadDummyCheck_p);
#endif
        ...
        const EIP164_Ch_Mask_t * const EOPTimeoutCtrl_p)
{
    ...
    memcpy(&EOPTimeoutCtrl, EOPTimeoutCtrl_p, sizeof(EIP164_Ch_Mask_t));
        ...
        const EIP164_Ch_Mask_t * const ChannelMask_p)
{
    ...
    memcpy(&Ch_Mask, ChannelMask_p, sizeof(EIP164_Ch_Mask_t));
